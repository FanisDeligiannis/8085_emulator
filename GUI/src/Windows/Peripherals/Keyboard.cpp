...
{
	Keyboard::Instance->Scan = val;
}

uint8_t GetKeys()
{
	Keyboard* inst = Keyboard::Instance;
	...
	if (inst->Scan != 0x7f)
	{
		...
		if (!(inst->Scan & 0b00000001))
		{
			if (inst->lastButton == 0)
			{
				out = 0b11111110;
			}
			else if (inst->lastButton == 1)
			{
				out = 0b11111101;
			}
			else if (inst->lastButton == 2)
			{
				out = 0b11111011;
			}
			else if (inst->lastButton == 3)
			{
				out = 0b11110111;
			}
		}
		else if (!(inst->Scan & 0b00000010))
		{
			if (inst->lastButton == 4)
			{
				out = 0b11111110;
			}
			else if (inst->lastButton == 5)
			{
				out = 0b11111101;
			}
			else if (inst->lastButton == 6)
			{
				out = 0b11111011;
			}
			else if (inst->lastButton == 7)
			{
				out = 0b11110111;
			}
		}
		else if (!(inst->Scan & 0b00000100))
		{
			if (inst->lastButton == 8)
			{
				out = 0b11111110;
			}
			else if (inst->lastButton == 9)
			{
				out = 0b11111101;
			}
			else if (inst->lastButton == 10)
			{
				out = 0b11111011;
			}
			else if (inst->lastButton == 11)
			{
				out = 0b11110111;
			}
		}

		else if (!(inst->Scan & 0b00001000))
		{
			if (inst->lastButton == 12)
			{
				out = 0b11111110;
			}
			else if (inst->lastButton == 13)
			{
				out = 0b11111101;
			}
			else if (inst->lastButton == 14)
			{
				out = 0b11111011;
			}
			else if (inst->lastButton == 15)
			{
				out = 0b11110111;
			}
		}
